...
import type { ProviderId, ModelInfo } from "../../../shared/src/types/provider.js";

// 按 modelId 前缀匹配的默认能力表
// 精确匹配优先于前缀匹配
const CAPABILITY_PRESETS: Record<string, Partial<ModelCapabilities>> = {
  // ── Kimi 系列（Moonshot / 百炼托管）──
  // 实测（2026-09，百炼）：kimi-k3 拒绝 temperature 参数，返回 400
  // invalid_parameter_error: "Parameter 'temperature'=0.1 is not supported"。
  // kimi-k2.5/2.6/2.7 的 temperature 不支持已在下方 K2 系列登记；此处补 kimi-k3
  // 精确条目与未知 kimi-k* 变体的保守兜底（省略参数永远安全）。
  "kimi-k3": { isReasoning: true, contextWindow: 262_144, maxOutputTokens: 65_536, temperature: { supported: false, range: [0, 1] }, supportsStructuredOutput: true, supportsVision: false, systemPromptMode: "message", recommendation: "Kimi K3 (百炼托管)" },
  "kimi-k":  { temperature: { supported: false, range: [0, 1] } },
  // ── 推理模型系列 ──
  ...
  // ── Qwen 3.x 推理模型系列（百炼 thinking 模式）──
  // qwen3.7-plus / qwen3.6 / qwen3.5 / qwen3-*thinking: 思考模式下 tool_choice=required 不支持，仅支持 auto
  "qwen3.7-max":    { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false, recommendation: "Qwen3.7 Max (推理旗舰)" },
  "qwen3.7-plus":   { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false, recommendation: "Qwen3.7 Plus (推理均衡)" },
  "qwen3.6-max":    { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3.6-plus":   { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3.6-flash":  { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3.6-35b-a3b": { isReasoning: true, contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3.6-27b":    { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3.5-plus":   { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3.5-flash":  { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3-max":      { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3-coder":    { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: true,  supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3-235b-a22b-thinking": { isReasoning: true, contextWindow: 131_072, maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] }, supportsStructuredOutput: true, supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3-30b-a3b-thinking":   { isReasoning: true, contextWindow: 131_072, maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] }, supportsStructuredOutput: true, supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  "qwen3-next-80b-a3b-thinking": { isReasoning: true, contextWindow: 131_072, maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] }, supportsStructuredOutput: true, supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false },
  // qwq-plus: QwQ 推理模型
  "qwq-plus":       { isReasoning: true,  contextWindow: 131_072,  maxOutputTokens: 32_768, temperature: { supported: true, range: [0, 2] },  supportsStructuredOutput: false, supportsVision: false, systemPromptMode: "message", supportsToolChoiceRequired: false, recommendation: "QwQ Plus (推理)" },
...
const PROVIDER_MODEL_IDS: Record<ProviderId, string[]> = {
  ...
  bailian: [
    // Kimi（工作区已开通；kimi-k3 不支持 temperature 参数）
    "kimi-k3",
    // Qwen3.7
